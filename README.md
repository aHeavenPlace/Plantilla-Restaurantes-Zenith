...
- Cada plato muestra una imagen generada con placehold.co (monograma sobre fondo temático): siempre carga y se ve correcta.
  Para fotos reales del cliente, sustituye la URL en `js/photos.js` (la clave es el nombre exacto del plato en `menu-data.js`).
